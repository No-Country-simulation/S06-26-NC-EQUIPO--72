...
ENDPOINT_DOCUMENTS = [
    ...
    },
    {
        ...
        "texto": (
            ...
            "Cómo viene cambiando, evolucionando o comportándose un indicador "
            "en el tiempo. "
            ...
            "formal en Florianópolis?, ¿cómo viene cambiando el desempleo?, "
            "¿cómo está evolucionando la tasa de empleo?, ¿cómo se comportó "
            "el índice de salud mental en los últimos meses? "
            "El filtro 'categoria' es OBLIGATORIO (SALUD_MENTAL, EMPLEO o EDUCACION). "
